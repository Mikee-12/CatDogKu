...
<div class="main-content p-4 p-md-5">
    ...
    <div class="table-card mb-4">
        <div class="table-card-header">
            <h5 class="fw-bold mb-0" style="font-size:15px">All Services</h5>
            <div class="d-flex align-items-center gap-3">
                <span class="text-muted" style="font-size:13px">Page <?= $current_pg ?> of <?= $total_pages ?></span>
                <a href="admin_addservice.php" class="btn btn-primary btn-sm"
                ...
                <tr>
                        ...
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <div>
                                <div class="fw-semibold" style="font-size:13.5px">
                                    <?= htmlspecialchars($sv['nama_service']) ?>
                                </div>
                                <?php if($sv['deskripsi']): ?>
                    ...
                    <td>
                        <div class="d-flex gap-1 flex-wrap">
                            ...
                            <a href="admin_editservice.php?id=<?= $sv['id_service'] ?>" class="btn-action btn-edit">
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <div class="d-flex align-items-center gap-3">
                    <div class="svc-icon" style="width:48px;height:48px;font-size:20px;border-radius:12px">
                        <i class="bi bi-scissors"></i>
                    </div>
                    <div>
            ...
            <div class="modal-footer" style="border-top:1px solid #f0f0f0;padding:16px 24px">
                <a id="modal-edit-link" href="#" class="btn btn-warning btn-sm"
...
function openDetail(sv) {
    ...
    document.getElementById('modal-edit-link').href = 'admin_editservice.php?id=' + sv.id_service;
